      ...
      <div className="container">
        ...
        <div className={styles.main__about_content}>
          ...
          <div className={styles.main__about_text}>
            <p>Hi there</p>
            <p>
              Im Ivan Sannikov <br></br> Information security specialist{' '}
            </p>
            <p>
              I am a 20 y.o. student from Innopolis University.<br></br>I like
              to study technology and apply the acquired skills in projects.
            </p>
          </div>
        </div>
      </div>
