    ...
    <footer className={styles.footer}>
      <div className="container">
        <section className={styles.footer__contacts}>
          <h2 className={styles.footer__contacts_header} id="contact-me">
            Ready to talk?
          </h2>
          ...
          <ul className={styles.footer__contacts_list}>
            <ContactLink
              id={'gh_link'}
              href={'https://github.com/Petrel321'}
              content={'GitHub'}
            />
            <ContactLink
              id={'tg_link'}
              href={'https://telegram.me/ivasan1'}
              content={'Telegram'}
            />
            <ContactLink
              id={'email'}
              href={'mailto:i.sannikov@innopolis.university'}
              content={'Email'}
            />
          </ul>
        </section>
